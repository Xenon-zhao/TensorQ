...
class QuantumCircuit:
    def __init__(self, n=53, bitstring=None, fname=None, fix_pairs=[],
        ...
        Initialize the QuantumCircuit
            Args:
                n (int): Qubit number. Default: ``53``
                bitstring (str): The bit string whose amplitude needs to be calculated. 
                fname (str): Quantum circuit filename, without '.py'. 
                fix_pairs (list): Fixed node pair.
            ...
            Attributes:
                n (int): Qubit number.
                gates (list): Quantum gate.
                neighbors (list): Adjacent tensors of each tensor.
                datatype (tyep): The data type of the tensor.
                tensors (list): Tensor generated by quantum circuits.
        """
        self.n = n
        if fname == None:
