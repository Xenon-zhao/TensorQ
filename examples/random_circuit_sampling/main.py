...
import torch
from network_contraction import contraction_single_task, collect_results, write_result
from search_order import search_order, read_samples
import argparse
import numpy as np
...
if need_search_order:
    search_order(n = 30, m = 14, seq = 'EFGH', device = 'cuda', sc_target = 30, seed = 0,
...
contraction_single_task(tensors, scheme, slicing_indices, args.taskid, args.device, n_sub_task= n_sub_task, use_cutensor=use_cutensor)
